...
const BuyCredit = () => {
  ...
  return (
    <motion.div
      ...
      <h1 className='text-3xl text-center font-semibold mb-6 sm:mb-10'>Choose the plan</h1>
      ...
      <div className='flex flex-wrap justify-center gap-6 text-left'>
        ...
        {plans.map((item, index) => (
          <div className='bg-white drop-shadow-sm border rounded-lg py-12 px-8 text-gray-600 hover:scale-105 transition-all duration-500' key={index}>
            ...
            <button className='bg-black text-white px-12 py-2.5 w-full min-w-52 mt-8 gap-2 items-center rounded-md'>{user ? 'purchase' : 'Get Started'}</button>
